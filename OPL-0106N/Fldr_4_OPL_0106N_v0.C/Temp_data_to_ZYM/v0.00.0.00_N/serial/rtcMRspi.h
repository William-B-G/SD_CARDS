...
extern void Read_MRAM_Array (uint32 addr, int16 *data, uint16 len, uint8 dev);
extern void Write_MRAM_Array(uint32 addr, int16 *data, uint16 len, uint8 dev);
extern void mrspi_dma_rx_int(void);
