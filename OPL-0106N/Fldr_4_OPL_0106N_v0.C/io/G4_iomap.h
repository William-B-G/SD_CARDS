...
// input
#define i_RLS_COPi0 &si_RLS_COPi0
#define i_CSS_COPi1 &si_CSS_COPi1
#define i_CTS_COPi2 &si_CTS_COPi2
#define i_DET_COPi3 &si_DET_COPi3

// OUTPUT
#define O_IFL_COPo0 &sO_IFL_COPo0
#define O_IFB_COPo1 &sO_IFB_COPo1
#define O_CUL_COPo2 &sO_CUL_COPo2
#define O_CDL_COPo3 &sO_CDL_COPo3
#define O_FAN_COPo4 &sO_FAN_COPo4
#define O_LIG_COPo5 &sO_LIG_COPo5
...
// (3) wbg 2018-9-02 OPL-0106N
//input
#define i_ronc   &si_ronc  
#define i_rono   &si_rono 
#define i_dclnc  &si_dclnc 
#define i_dclno  &si_dclno 
#define i_dolnc  &si_dolnc 
#define i_dolno  &si_dolno 
#define i_heavy  &si_heavy 
#define i_nudge  &si_nudge 
#define i_close  &si_close 
#define i_open   &si_open  

//output
#define O_CN19V  &SO_CN19V 
#define O_CN18V  &SO_CN18V 
#define O_CLOSE  &SO_CLOSE 
#define O_OPEN   &SO_OPEN  
#define O_NUDGE  &SO_NUDGE 
#define O_HEAVY  &SO_HEAVY 
#define O_DCL    &SO_DCL   
#define O_RO     &SO_RO    
#define O_DOL    &SO_DOL 
...
// WBG 2018-5-17
// input
#define i_CTA_ctcan   &si_CTA_ctcan
#define i_INS_ctcan   &si_INS_ctcan
#define i_IEN_ctcan   &si_IEN_ctcan
#define i_IU_ctcan    &si_IU_ctcan
#define i_ID_ctcan    &si_ID_ctcan
#define i_FANST_ctcan &si_FANST_ctcan
#define i_LIGST_ctcan &si_LIGST_ctcan
#define i_CDL_T_ctcan &si_CDL_T_ctcan
#define i_CUL_T_ctcan &si_CUL_T_ctcan
#define i_CTS_T_ctcan &si_CTS_T_ctcan
#define i_FFSWT_ctcan &si_FFSWT_ctcan

// output
#define O_CSS_ctcan   &SO_CSS_ctcan
//#define O_CSS_ctcan   &SO_CSS_ctcan

// wbg 2018-5-18
// input
#define i_CST_T_ctcan    &si_CST_T_ctcan
#define i_ICC_T_ctcan    &si_ICC_T_ctcan
#define i_ICA_T_ctcan    &si_ICA_T_ctcan
#define i_ICI_T_ctcan    &si_ICI_T_ctcan
#define i_ACC_T_ctcan    &si_ACC_T_ctcan

// output
#define O_C120T_ctcan   &SO_C120T_ctcan
#define O_L15RL_ctcan   &SO_L15RL_ctcan
#define O_L15_T_ctcan   &SO_L15_T_ctcan
#define O_FSS_ctcan     &SO_FSS_ctcan
#define O_CST_ctcan     &SO_CST_ctcan
#define O_ICC_ctcan     &SO_ICC_ctcan

// wbg 2018-8-06
// input
#define i_EE_ctcan      &si_EE_ctcan
#define i_DOL_ctcan     &si_DOL_ctcan
#define i_DCL_ctcan     &si_DCL_ctcan
#define i_SE_ctcan      &si_SE_ctcan
#define i_DC_ctcan      &si_DC_ctcan

// output
#define O_DO_ctcan      &SO_DO_ctcan
#define O_L15_ctcan     &SO_L15_ctcan
#define O_L25_ctcan     &SO_L25_ctcan

// wbg 2018-5-18
// input
#define i_L15_ctcan    &si_L15_ctcan
#define i_L25_ctcan    &si_L25_ctcan


// output
#define O_ICA_ctcan   &SO_ICA_ctcan
#define O_ICI_ctcan   &SO_ICI_ctcan
#define O_ACC_ctcan   &SO_ACC_ctcan
#define O_BELL_ctcan  &SO_BELL_ctcan
#define O_CLC_ctcan   &SO_CLC_ctcan

// wbg 2018-5-18
// input
#define i_C24_T_ctcan    &si_C24_T_ctcan

// output
#define O_C24_ctcan   &SO_C24_ctcan

// wbg 2018-6-27
// output
#define O_dbg01   &SO_dbg01
#define O_dbg02   &SO_dbg02
#define O_dbg03   &SO_dbg03
#define O_dbg04   &SO_dbg04
#define O_dbg05   &SO_dbg05
#define O_dbg06   &SO_dbg06
#define O_dbg07   &SO_dbg07
#define O_dbg08   &SO_dbg08
#define O_dbg09   &SO_dbg09
#define O_dbg10   &SO_dbg10
