 ...
 * REVISION:  1.1m                                    All Rights Reserved *
 *                                                                        *
 * DESCRIPTION:                                                           *
...
/* wakeup status */
    ...
    typedef union uPSR2 {
        ...
        struct {
            ...
            vuint16_t _MTB:1;    /* media access test symbol MTS received on channel B */
    ...
    typedef union uSSR {
        ...
        struct {
            ...
            vuint16_t _SEB:1;    /* syntax error on channel B */
