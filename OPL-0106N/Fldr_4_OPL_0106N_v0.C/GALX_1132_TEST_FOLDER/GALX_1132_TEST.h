...
extern uint8 Initial_Pwr_Up_Complete;
extern uint8 CurrentTestPassFail;
extern uint8 Current_113x_TestPassFail;
extern uint8 Current_1139_TestPassFail;
...
extern int16 Tst_DisplayMsgBrd_C(int16 dummy);
