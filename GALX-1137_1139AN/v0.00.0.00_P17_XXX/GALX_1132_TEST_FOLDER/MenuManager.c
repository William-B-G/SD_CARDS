...
//        else Test_ConsB_24 = 1;
        if( ( Initial_Pwr_Up_Complete == 0) && (Test_ConsB_24) )New_LCD_Menu = Reset_1; // Reset_1;
        else New_LCD_Menu = LookAtButtons;
        SIU.GPDO[Z6_LED].R = !SIU.GPDO[Z6_LED].R;  // toggle LED
        break;
        
           //  send reset 0, 2, 5, 8, 10 to all hall station 1137 boards     
    case Reset_1:    
        test_Loop = 0; 
        Initial_Pwr_Up_Complete = 1;   
        ...
        { 
            ...
            delay(2000);
            petdog();
            New_LCD_Menu =  Hall_Off_1; // Reset_2;	
        }    	
    	break;
    ...
    case Hall_Off_1:
        test_Loop = 0;    
        if( Send_Hall_Data(0)  ==  FINISHED_WITH_SERVICE )
        { 
            SIU.GPDO[Z6_LED].R = !SIU.GPDO[Z6_LED].R;  // toggle LED
            petdog();
            delay(2000);
            petdog();
            New_LCD_Menu = Reset_2;	
        }    
    	break;  
...
//Send_Hall_Data(5)        
    case Reset_2: 
        ...
        { 
            ...
            delay(2000);
            petdog();
            New_LCD_Menu =  Hall_Off_2; // Reset_3;	
        }    	
    	break;
    ...
    case Reset_3:  
        ...
        { 
            ...
            delay(2000);
            petdog();
            New_LCD_Menu =  Hall_Off_3; // LookAtButtons; // Hall_Off_3;  // LookAtButtons
//            test_Loop = 0;	
        }    	
    	break;    
