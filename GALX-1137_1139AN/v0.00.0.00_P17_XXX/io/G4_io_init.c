...
*/	
	...
	// type = 0x01 for output, 0x10 for send name
	//CAN Add 12, dip switch setting 1
...
/*	
	...
	init_io(o_CTo5,CTCAN," CTo5",0x01,NoLight);
*/	
	init_io(o_CTo6,CTCAN," CTo6",0x11,NoLight);
	init_io(o_CTo7,CTCAN," CTo7",0x11,NoLight);
	init_io(o_CTo8,CTCAN," CTo8",0x11,NoLight);
	init_io(o_CTo9,CTCAN," CTo9",0x11,NoLight);
	init_io(o_CTo10,CTCAN,"CTo10",0x11,NoLight);
	init_io(o_CTo11,CTCAN,"CTo11",0x11,NoLight);		
