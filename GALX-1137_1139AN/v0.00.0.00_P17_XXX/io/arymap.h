...
uint8 INED = 3;        	// Inspection Switch Enable Input Data Array Number

int16 SFC = BRD2B;     	// Secondary Fault Control Input Board Address
uint8 SFCB = BIT5;    	// Secondary Fault Control Input Bit Number
uint8 SFCD = 3;        	// Secondary Fault Control Input Data Array Number
...
{			  // Used with remote car stations
	...
	// ON 2nd SERIAL CAR BOARD
	BRD9A,                  // Car Call #21 Input Board Address
	BRD9A,                  // Car Call #22 Input Board Address
	BRD9A,                  // Car Call #23 Input Board Address
	BRD9A,                  // Car Call #24 Input Board Address
	BRD9A,                  // Car Call #25 Input Board Address
	BRD9A,                  // Car Call #26 Input Board Address
	BRD9A,                  // Car Call #27 Input Board Address
	BRD9A,                  // Car Call #28 Input Board Address
	BRD9B,                  // Car Call #29 Input Board Address
	BRD9B,                  // Car Call #30 Input Board Address
	BRD9B                   // Car Call #31 Input Board Address
	},
{			  // Used with remote car stations
	0,                      // Not Used
	// 0n 1st Serial Car board
...
{			  // Used with Remote car call
	...
	// ON 2nd serial car board
	24,                     // Car Call #21 Input Array Number
	24,                     // Car Call #22 Input Array Number
	24,                     // Car Call #23 Input Array Number
	24,                     // Car Call #24 Input Array Number
	24,                     // Car Call #25 Input Array Number
	24,                     // Car Call #26 Input Array Number
	24,                     // Car Call #27 Input Array Number
	24,                     // Car Call #28 Input Array Number
	25,                     // Car Call #29 Input Array Number
	25,                     // Car Call #30 Input Array Number
	25                      // Car Call #31 Input Array Number
	},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 1st serial car board
...
{			  // Used with Remote car call
	...
	// ON 2nd Serial Car Board
	BRD10A,                 // Car Call Light #21 Output Board Address
	BRD10A,                 // Car Call Light #22 Output Board Address
	BRD10A,                 // Car Call Light #23 Output Board Address
	BRD10A,                 // Car Call Light #24 Output Board Address
	BRD10A,                 // Car Call Light #25 Output Board Address
	BRD10A,                 // Car Call Light #26 Output Board Address
	BRD10A,                 // Car Call Light #27 Output Board Address
	BRD10A,                 // Car Call Light #28 Output Board Address
	BRD10B,                 // Car Call Light #29 Output Board Address
	BRD10B,                 // Car Call Light #30 Output Board Address
	BRD10B                  // Car Call Light #31 Output Board Address
	},
{
	0,                      // Not Used
	// ON 1st Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 2nd Serial Car Board
	27,                     // Car Call Light #21 Output Array Number
	27,                     // Car Call Light #22 Output Array Number
	27,                     // Car Call Light #23 Output Array Number
	27,                     // Car Call Light #24 Output Array Number
	27,                     // Car Call Light #25 Output Array Number
	27,                     // Car Call Light #26 Output Array Number
	27,                     // Car Call Light #27 Output Array Number
	27,                     // Car Call Light #28 Output Array Number
	28,                     // Car Call Light #29 Output Array Number
	28,                     // Car Call Light #30 Output Array Number
	28                      // Car Call Light #31 Output Array Number
	},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 1st Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 3RD Serial Car Board
	BRD9B,                 // Rear Car Call #21 Input Board Address
	BRD9B,                 // Rear Car Call #22 Input Board Address
	BRD9B,                 // Rear Car Call #23 Input Board Address
	BRD9B,                 // Rear Car Call #24 Input Board Address
	BRD9C,                 // Rear Car Call #25 Input Board Address
	BRD9C,                 // Rear Car Call #26 Input Board Address
	BRD9C,                 // Rear Car Call #27 Input Board Address
	BRD9C,                 // Rear Car Call #28 Input Board Address
	BRD9C,                 // Rear Car Call #29 Input Board Address
	BRD9C,                 // Rear Car Call #30 Input Board Address
	BRD9C,                 // Rear Car Call #31 Input Board Address
},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 2ND Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 3RD Serial Car Board
	BIT5,                   // Rear Car Call #21 Input Bit Number
	BIT6,                   // Rear Car Call #22 Input Bit Number
	BIT7,                   // Rear Car Call #23 Input Bit Number
	BIT8,                   // Rear Car Call #24 Input Bit Number
	BIT1,                   // Rear Car Call #25 Input Bit Number
	BIT2,                   // Rear Car Call #26 Input Bit Number
	BIT3,                   // Rear Car Call #27 Input Bit Number
	BIT4,                   // Rear Car Call #28 Input Bit Number
	BIT5,                   // Rear Car Call #29 Input Bit Number
	BIT6,                   // Rear Car Call #30 Input Bit Number
	BIT7,                   // Rear Car Call #31 Input Bit Number
},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 2ND Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 2nd Serial Car Board
	BRD10B,                 // Rear Car Call Light #21 Output Board Address
	BRD10B,                 // Rear Car Call Light #22 Output Board Address
	BRD10B,                 // Rear Car Call Light #23 Output Board Address
	BRD10B,                 // Rear Car Call Light #24 Output Board Address
	BRD10C,                 // Rear Car Call Light #25 Output Board Address
	BRD10C,                 // Rear Car Call Light #26 Output Board Address
	BRD10C,                 // Rear Car Call Light #27 Output Board Address
	BRD10C,                 // Rear Car Call Light #28 Output Board Address
	BRD10C,                 // Rear Car Call Light #29 Output Board Address
	BRD10C,                 // Rear Car Call Light #30 Output Board Address
	BRD10C                  // Rear Car Call Light #31 Output Board Address
},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 1st Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 2nd Serial Car Board
	BIT5,                   // Rear Car Call Light #21 Output Bit Number
	BIT6,                   // Rear Car Call Light #22 Output Bit Number
	BIT7,                   // Rear Car Call Light #23 Output Bit Number
	BIT8,                   // Rear Car Call Light #24 Output Bit Number
	BIT1,                   // Rear Car Call Light #25 Output Bit Number
	BIT2,                   // Rear Car Call Light #26 Output Bit Number
	BIT3,                   // Rear Car Call Light #27 Output Bit Number
	BIT4,                   // Rear Car Call Light #28 Output Bit Number
	BIT5,                   // Rear Car Call Light #29 Output Bit Number
	BIT6,                   // Rear Car Call Light #30 Output Bit Number
	BIT7,                   // Rear Car Call Light #31 Output Bit Number
},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 1st Serial Car Board
...
{			  // Used with Remote car call
	...
	// ON 3RD Serial Car Board
	28,                     // Rear Car Call Light #21 Output Array Number
	28,                     // Rear Car Call Light #22 Output Array Number
	28,                     // Rear Car Call Light #23 Output Array Number
	28,                     // Rear Car Call Light #24 Output Array Number
	29,                     // Rear Car Call Light #25 Output Array Number
	29,                     // Rear Car Call Light #26 Output Array Number
	29,                     // Rear Car Call Light #27 Output Array Number
	29,                     // Rear Car Call Light #28 Output Array Number
	29,                     // Rear Car Call Light #29 Output Array Number
	29,                     // Rear Car Call Light #30 Output Array Number
	29                      // Rear Car Call Light #31 Output Array Number
},
{			  // Used with Remote car call
	0,                      // Not Used
	// ON 2ND Serial Car Board
...
{			  // Used with serial car call
	...
	// ON 3RD Serial Car Board
	BRD10A,                 // Security Car Call Latch #24 Input Board Address
	BRD10A,                 // Security Car Call Latch #25 Input Board Address
	BRD10A,                 // Security Car Call Latch #26 Input Board Address
	BRD10A,                 // Security Car Call Latch #27 Input Board Address
	BRD10A,                 // Security Car Call Latch #28 Input Board Address
	BRD10A,                 // Security Car Call Latch #29 Input Board Address
	BRD10A,                 // Security Car Call Latch #30 Input Board Address
	BRD10A                  // Security Car Call Latch #31 Input Board Address
};
...
{			  // Used with serial car call
	...
	// ON 2nd Serial Car Board
	27,                     // Security Car Call Latch #24 Input Array Number
	27,                     // Security Car Call Latch #25 Input Array Number
	27,                     // Security Car Call Latch #26 Input Array Number
	27,                     // Security Car Call Latch #27 Input Array Number
	27,                     // Security Car Call Latch #28 Input Array Number
	27,                     // Security Car Call Latch #29 Input Array Number
	27,                     // Security Car Call Latch #30 Input Array Number
	27                      // Security Car Call Latch #31 Input Array Number
};
...
{			  // Used with serial car call
	...
	// ON 2nd Serial Car Board
	BRD10B,                 // Rear Security Car Call Latch #24 Output Board Address
	BRD10B,                 // Rear Security Car Call Latch #25 Output Board Address
	BRD10B,                 // Rear Security Car Call Latch #26 Output Board Address
	BRD10B,                 // Rear Security Car Call Latch #27 Output Board Address
	BRD10C,                 // Rear Security Car Call Latch #28 Output Board Address
	BRD10C,                 // Rear Security Car Call Latch #29 Output Board Address
	BRD10C,                 // Rear Security Car Call Latch #30 Output Board Address
	BRD10C                  // Rear Security Car Call Latch #31 Output Board Address
};
...
{			  // Used with serial car call
	...
	// ON 2nd Serial Car Board
	BIT5,                   // Rear Security Car Call Latch #24 Output Bit Number
	BIT6,                   // Rear Security Car Call Latch #25 Output Bit Number
	BIT7,                   // Rear Security Car Call Latch #26 Output Bit Number
	BIT8,                   // Rear Security Car Call Latch #27 Output Bit Number
	BIT1,                   // Rear Security Car Call Latch #28 Output Bit Number
	BIT2,                   // Rear Security Car Call Latch #29 Output Bit Number
	BIT3,                   // Rear Security Car Call Latch #30 Output Bit Number
	BIT4                    // Rear Security Car Call Latch #31 Output Bit Number
};
...
{			  // Used with serial car call
	...
	// ON 3RD Serial Car Board
	28,                     // Rear Security Car Call Latch #24 Output Array Number
	28,                     // Rear Security Car Call Latch #25 Output Array Number
	28,                     // Rear Security Car Call Latch #26 Output Array Number
	28,                     // Rear Security Car Call Latch #27 Output Array Number
	29,                     // Rear Security Car Call Latch #28 Output Array Number
	29,                     // Rear Security Car Call Latch #29 Output Array Number
	29,                     // Rear Security Car Call Latch #30 Output Array Number
	29                      // Rear Security Car Call Latch #31 Output Array Number
};
...
{					// Use when using car call comm
	...
	// ON 2nd Serial Car Board
	BRD9A,                 // Car Call Security Input Board Address	ccs #24	    
	BRD9A,                 // Car Call Security Input Board Address	ccs #25	   
	BRD9A,                 // Car Call Security Input Board Address	ccs #26	    
	BRD9A,                 // Car Call Security Input Board Address	ccs #27	   
	BRD9A,                 // Car Call Security Input Board Address	ccs #28	    
	BRD9A,                 // Car Call Security Input Board Address	ccs #29	   
};
...
extern const unsigned char ccsd[32] = 
{
	...
	// ON 2nd Serial Car Board
	24,                     // Car Call Security Input Array Number		ccs #24	
	24,                     // Car Call Security Input Array Number		ccs #25	
	24,                     // Car Call Security Input Array Number		ccs #26	
	24,                     // Car Call Security Input Array Number		ccs #27	
	24,                     // Car Call Security Input Array Number		ccs #28	
	24,                     // Car Call Security Input Array Number		ccs #29	
};
...
{					// Use when using car call comm
	...
	// ON 2nd Serial Car Board
	BRD9B,                 // Car Call Security Input Board Address	ccs #24	    
	BRD9B,                 // Car Call Security Input Board Address	ccs #25	   
	BRD9B,                 // Car Call Security Input Board Address	ccs #26	    
	BRD9B,                 // Car Call Security Input Board Address	ccs #27	   
	BRD9B,                 // Car Call Security Input Board Address	ccs #28	    
	BRD9C,                 // Car Call Security Input Board Address	ccs #29	   
};
...
extern const unsigned char rccsb[32] = 
{
	...
	BIT8,					// Car Call Security Input Bit Number		ccs #23	
	// ON 2nd Serial Car Board
	BIT5,                   // Car Call Security Input Bit Number		ccs #24	 
	BIT6,                   // Car Call Security Input Bit Number		ccs #25	
	BIT7,					// Car Call Security Input Bit Number		ccs #26	 
	BIT8,                   // Car Call Security Input Bit Number		ccs #27	
	BIT1,                   // Car Call Security Input Bit Number		ccs #28	 
	BIT2,                   // Car Call Security Input Bit Number		ccs #29	
};
...
extern const unsigned char rccsd[32] = 
{
	...
	// ON 2nd Serial Car Board
	25,                     // Car Call Security Input Array Number		ccs #24	
	25,                     // Car Call Security Input Array Number		ccs #25	
	25,                     // Car Call Security Input Array Number		ccs #26	
	25,                     // Car Call Security Input Array Number		ccs #27	
	26,                     // Car Call Security Input Array Number		ccs #28	
	26,                     // Car Call Security Input Array Number		ccs #29	
};
...
extern const int16 EOR [4] = {BRD2A,BRD27B,BRD29B,BRD2A};		// Elevator Off Reset input board address
extern const int8 EORB [4] = {BIT5,BIT1,BIT7,BIT4};		// Elevator Off Reset input bit number
extern const int8 EORD [4] = {3,79,85,3};				// Elevator Off Reset input data array number
...
extern const int16 OSERL [2] = {BRD5C,BRD30B} ;
extern const uint8 OSERLB [2] = {BIT2,BIT7};
extern const uint8 OSERLD [2] = {14,88};

extern const int16 OSERB [1] = {BRD30B} ;
extern const uint8 OSERBB [1] = {BIT8};
extern const uint8 OSERBD [1] = {88};

extern const int16 OSERA [1] = {BRD29B};
extern const uint8 OSERAB [1] = {BIT8};
extern const uint8 OSERAD [1] = {85};
...
extern const uint8 ZOND [3] = {68,38,132};				// Zoning Enable Car switch Input Data Array Number
	...
	// Note same i/o location as EMS / ATT / HBE
...
// Extra Door Time and Attendant Bypass and hugs bypass input maped to the same location
...
extern const int16 HUGO [3] = {BRD24B,BRD14C,BRD48C};		// Discrete/Digital Position Indicator Output 1 Board Address
extern const uint8 HUGOB [3] = {BIT6,BIT3,BIT2};	  		// Discrete/Digital Position Indicator Output 1 Bit Number
extern const uint8 HUGOD [3] = {70,41,143};		  		// Discrete/Digital Position Indicator Output 1 Array Number
...
extern const int16 HUGA [3] = {BRD24C,BRD14C,BRD44C};		// HUGS alarm Output Board Address
extern const uint8 HUGAB [3] = {BIT2,BIT7,BIT3};			// HUGS alarm Output Bit Number
extern const uint8 HUGAD [3] = {71,41,131};				// HUGS alarm Output Array Number
...
extern const int16 FS [2] = {BRD2B,BRD29A};       // Fire Service Switch Input Board Address
extern const uint8 FSB [2] = {BIT6,BIT1};        	// Fire Service Switch Input Bit Number
extern const uint8 FSD [2] = {4,84};           	// Fire Service Switch Input Data Array Number

extern const int16 FSX [2] = {BRD2A,BRD29A};		// Fire Switch Aux. Input Board Address
extern const uint8 FSXB [2] = {BIT2,BIT2};		// Fire Switch Aux. Input Bit Number
extern const uint8 FSXD [2] = {3,84};				// Fire Switch Aux. Input Data Array Number

extern const int16 BP [2] = {BRD2B,BRD29A};      	// Fire Service Bypass Input Board Address
extern const uint8 BPB [2] = {BIT5,BIT3};       	// Fire Service Bypass Input Bit Number
extern const uint8 BPD [2] = {4,84};          	// Fire Service Bypass Input Data Array Number

extern const int16 MES [2] = {BRD2B,BRD29A};      // Main Eggress Smoke Detector Board Address
extern const uint8 MESB [2] = {BIT3,BIT4};       	// Main Eggress Smoke Detector Bit Number
extern const uint8 MESD [2] = {4,84};         	// Main Eggress Smoke Detector Data Array Number

extern const int16 ALT [2] = {BRD2B,BRD29A};      // Fire Service Alternate Floor Input Board Address
extern const uint8 ALTB [2] = {BIT4,BIT5};		// Fire Service Alternate Floor Input Bit Number
extern const uint8 ALTD [2] = {4,84};				// Fire Service Alternate Floor Input Data Array Number

extern const int16 MRS [2] = {BRD2B,BRD29A};     	// Machine Room Smoke Detector Input Board Address
extern const uint8 MRSB [2] = {BIT2,BIT6};     	// Machine Room Smoke Detector Input Bit Number
extern const uint8 MRSD [2] = {4,84};      	  	// Machine Room Smoke Detector Input Data Array Number

extern const int16 HWS [2] = {BRD2B,BRD29A};     	// Hoistway Smoke Input Board Address
extern const uint8 HWSB [2] = {BIT1,BIT7};     	// Hoistway Smoke Input Bit Number
extern const uint8 HWSD [2] = {4,84};	        	// Hoistway Smoke Input Data Array Number

extern const int16 HWS2 [2] = {BRD2B,BRD29A};    	// Hoistway Smoke 2 Input Board Address
extern const uint8 HWS2B [2] = {BIT3,BIT8};     	// Hoistway Smoke 2 Input Bit Number
extern const uint8 HWS2D [2] = {3,84};        	// Hoistway Smoke 2 Input Data Array Number

extern const int16 EMP [2] = {BRD2A,BRD29B};      // Emergency Power Input Board Address
extern const uint8 EMPB [2] = {BIT8,BIT1};       	// Emergency Power Input Bit Number
extern const uint8 EMPD [2] = {3,85};          	// Emergency Power Input Data Array Number

extern const int16 EPS [2] = {BRD2A,BRD29B};     	// Emergency Power Select Input Board Address
extern const uint8 EPSB [2] = {BIT7,BIT2};     	// Emergency Power Select Input Bit Number
extern const uint8 EPSD [2] = {3,85};	        	// Emergency Power Select Input Data Array Number

// Note: EPT is the same i/o location as EMSH

extern const int16 EPT[3] = {BRD2A,BRD2C,BRD29B};		// Emergency Power Transfer Input Board Address
extern const uint8 EPTB[3] = {BIT6,BIT2,BIT3};	 	// Emergency Power Transfer Input Bit Number
extern const uint8 EPTD[3] = {3,5,85};				// Emergency Power Transfer Input Data Array

extern const int16 HEOF[2] = {BRD2C,BRD29B};     		// Hall Switch Elevator Off Input Board Address
extern const uint8 HEOFB[2] = {BIT7,BIT4};      		// Hall Switch Elevator Off Input Bit Number
extern const uint8 HEOFD[2] = {5,85};         		// Hall Switch Elevator Off Input Data Array Number
...
extern const uint8 JAILBD[2] = {5,85};         		// Jail Break Input Data Array Number
	...
	// RTL for traction
extern const int16 RTL[2] = {BRD2C,BRD29B};			// Return to Lobby Input Board Address
extern const uint8 RTLB[2] = {BIT3,BIT5};				// Return to Lobby Input Bit Number
extern const uint8 RTLD[2] = {5,85};	  				// Return to Lobby Input Data Array Number

extern const int16 EMSH[2] = {BRD2A,BRD29B};			// Emergency Medical Service Hall Input	Board Address
extern const uint8 EMSHB[2] = {BIT6,BIT6};			// Emergency Medical Service Hall Input Bit Number
extern const uint8 EMSHD[2] = {3,85};					// Emergency Medical Service Hall Input Data Array

// The P input is used for RTL on hydros prior to 2004 I/O Change.
	// RTL for hydro
extern const int16 RTLH[3] = {BRD4B,BRD2C,BRD29B};	// Return to Lobby Input Board Address
extern const uint8 RTLHB[3] = {BIT1,BIT3,BIT7};		// Return to Lobby Input Bit Number
extern const uint8 RTLHD[3] = {10,5,85};     			// Return to Lobby Input Data Array Number

extern const int16 EMLH[2] = {BRD5C,BRD30C};			// Emergency Medical Hall light output Board Address
extern const uint8 EMLHB[2] = {BIT1,BIT4};			// Emergency Medical Hall light output Bit Number
extern const uint8 EMLHD[2] = {14,89}; 				// Emergency Medical Hall light output Data Array Number

extern const int16 EPLH [2] = {BRD30B,BRD30C};       	// Emergency Power Hall Light Output Board Address
extern const uint8 EPLHB [2] = {BIT1,BIT5};        	// Emergency Power Hall Light Output Bit Number
extern const uint8 EPLHD [2] = {88,89};           	// Emergency Power Hall Light Output Data Array Number

extern const int16 EPRL [2] = {BRD30B,BRD30C};       	// Emergency Power Recall Light Output Board Address
extern const uint8 EPRLB [2] = {BIT2,BIT6};        	// Emergency Power Recall Light Output Bit Number
extern const uint8 EPRLD [2] = {88,89};           	// Emergency Power Recall Light Output Data Array Number

extern const int16 EPSL [2] = {BRD30B,BRD30C};       	// Emergency Power Select Light Output Board Address
extern const uint8 EPSLB [2] = {BIT3,BIT7};        	// Emergency Power Select Light Output Bit Number
extern const uint8 EPSLD [2] = {88,89};           	// Emergency Power Select Light Output Data Array Number

extern const int16 FLH [2] = {BRD30B,BRD30C};       	// Hall Fire Light Output Board Address
extern const uint8 FLHB [2] = {BIT4,BIT8};        	// Hall Fire Light Output Bit Number
extern const uint8 FLHD [2] = {88,89};           		// Hall Fire Light Output Data Array Number
...
4/21/05 4.08 mhd	1. Changed ccs security input SECUR to be at the 0th location in the array and to
					   be the first i/o.
1/26/10 V5.51.9 mhd	1. Moved MBC from hmmap.h.
10/26/10 v5.52.41 mhd	1. Moved hall fire io to board 29.
